...
if(
    ...
    if($user->update()){
        ...
        // tell the user
        echo json_encode(array("message" => "User was updated successfully.", "success" => true));
    }
    ...
    // if unable to update the user, tell the user
        ...
        // tell the user
        echo json_encode(array("message" => "Unable to update the user.", "success" => false));
    }
}
...
// tell the user data is incomplete
    ...
    // tell the user
    echo json_encode(array("message" => "Unable to update the user. Data is incomplete.", "success" => false));
}
?>