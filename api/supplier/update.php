...
if(
	...
	$supplier->modified = date('Y-m-d H:i:s');
    ...
    if($supplier->update()){
        ...
        // tell the user
        echo json_encode(array("message" => "Supplier was updated successfully.", "success" => true));
    }
    ...
    // if unable to update the supplier, tell the user
        ...
        // tell the user
        echo json_encode(array("message" => "Unable to update the side.", "success" => false));
    }
}
...
// tell the user data is incomplete
    ...
    // tell the user
    echo json_encode(array("message" => "Unable to update the supplier. Data is incomplete.", "success" => false));
}
?>