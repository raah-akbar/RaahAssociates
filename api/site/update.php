...
if(
	...
	$site->modified = date('Y-m-d H:i:s');
    ...
    if($site->update()){
        ...
        // tell the user
        echo json_encode(array("message" => "Site was updated successfully.", "success" => true));
    }
...
// tell the user data is incomplete
    ...
    // tell the user
    echo json_encode(array("message" => "Unable to update the site. Data is incomplete.", "success" => false));
}
?>